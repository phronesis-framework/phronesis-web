  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[1200px] items-center justify-center gap-3 px-12 py-2 text-[13px] sm:text-sm">
        <a href={href} className="group inline-flex items-center gap-2 text-center">
        ...
        <button
          ...
          className="text-muted-foreground hover:bg-background-elevated hover:text-foreground absolute top-1/2 right-3 inline-flex h-7 w-7 -translate-y-1/2 items-center justify-center rounded-md transition-colors"
        >
